    ...
    <Layout page={"aboutme"}>
      ...
      <div className="leftscrollpsy hide-on-small-only m3 l2 m2">
        <ul className="section table-of-contents" style={{ position: "fixed" }}>
          <li>
            <a href="#aboutmediv">Introduction</a>
          </li>
          <li>
            <a href="#hobbiesdiv">Hobbies</a>
          </li>
          <li>
            <a href="#experiencediv">Skills</a>
          </li>
        </ul>
      </div>
      <div
        ...
        className={classNames(
          styles.aboutmediv,
          "container valign-wrapper section scrollspy"
        )}
      >
        <div className={classNames(styles.introdiv, "row")}>
          <div className="col s12 m4">
            <img
              ...
              src="./images/avatar_aymane.png"
              alt="AIT LAASRI Aymane"
            />
          </div>
          <div className="col s12 m8 center-align">
            <h3>My name is AIT LAASRI Aymane</h3>
            <p className="flow-text">
              I'm a software engineer that graduated from{" "}
              <a
                style={{ color: "#09BC8A" }}
                href="
                                https://www.enset-media.ac.ma/"
                target="_blank"
              >
                ENSET-M
              </a>
              , I specialize in software engineering and distributed computing
              systems and I'm currently working as a full stack web developer at{" "}
              <a
                style={{ color: "#F15F27" }}
                href="https://adria-bt.com/en/"
                target="_blank"
              >
                Adria-BT
              </a>
        ...
        <div className="container valign-wrapper">
          <div className="row">
            <div className="valign-wrapper">
              <div
                id="hobbiesdiv"
                className="col s12 center-align secion scrollspy"
              >
                <p className="flow-text" style={{ marginBottom: "80px" }}>
                  I like to use my spare time to learn new stuff about web
                  developpement.
                  <br />
                ...
                <div className={classNames(styles.customcard, "col s12 m4")}>
                  ...
                  <p className="flow-text">
                    I like to swim in pools whatever season it may be,
                    especially around summer time.
                  </p>
                </div>
                <div className="col s12 m4">
                  ...
                  <p className="flow-text">
                    Solving puzzles and doing human benchmarks is my favorite
                    way to waste some time as it keeps me entertained and my
                    mind active.
                  </p>
                </div>
              </div>
      ...
      <div
        id="experiencediv"
        className="container valign-wrapper section scrollspy"
      >
        <div className="row">
          <div className="valign-wrapper">
            <div className="col s12 center-align">
              <p className="flow-text">
                Throughout my career I've worked with alot of frameworks,
                libraries and technologies such as :
              </p>
              ...
              <div className={classNames(styles.expCard, "col s12 m4")}>
                <i className="fab fa-atlassian fa-8x"></i>
                <h3>Jira Forge</h3>
              </div>
              <div className={classNames(styles.expCard, "col s12 m4")}>
                <i className="fab fa-java fa-8x"></i>
                <h3>Java</h3>
              </div>
              <div className={classNames(styles.expCard, "col s12 m4")}>
                <i className="fab fa-envira fa-8x"></i>
                <h3>Spring Boot</h3>
              </div>
              <div className={classNames(styles.expCard, "col s12 m4")}>
                <i className="fab fa-bitbucket fa-8x"></i>
                <h3>BitBucket</h3>
              </div>
              <div className={classNames(styles.expCard, "col s12 m4")}>
              ...
              <div className={classNames(styles.expCard, "col s12 m4")}>
                <i className="fab fa-symfony fa-8x"></i>
                <h3>Symfony</h3>
              </div>
              <div className={classNames(styles.expCard, "col s12 m4")}>
                <i className="fab fa-docker fa-8x"></i>
                <h3>Docker</h3>
              </div>
            </div>
          </div>
